...
const SearchContainer = () => {
    ...
    <Container fluid className="search__container">
        ...
        <Row lg="auto" className="search__row search__row-input" >
            <Col><InputSearch searchResponse={searchResponse} /> </Col>
        </Row>
        <Row className="search__row">
            <Col ><p className="search__text">
                Recuerda que tu equipo debe estar conformado por <strong>máximo</strong> 3 villanos y 3 héroes
            </p></Col>
        </Row>
        <Row lg="auto" className="search__row">
            {dataResponse.response === "success" ? <CardResponse dataResponse={dataResponse} /> : <p>No hay héroes con ese nombre!</p> }
        </Row>
    </Container>
    )
}
